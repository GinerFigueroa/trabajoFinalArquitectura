...
if (!$this->objTelegramDAO->pacienteActivo($idPaciente)) {
    $this->objMensaje->mensajeSistemaShow("El paciente seleccionado no está activo en el sistema", "./indexRegistrarNuevoRecordatorio.php", "error");
    return;
}
        ...
        // En el método procesarRegistroPaciente, reemplaza estas líneas:
